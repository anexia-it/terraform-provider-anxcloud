...
// Query a location via the unique code for later reference.
data "anxcloud_core_location" "anx04" { code = "ANX04" }

// To create a new server, we have to create a VLAN with the related
// IP addresses first.
...
// Once we have all our network requirements in place, we can actually
// create our new webserver.
